      ...
      <Card className={classes.card}>
        ...
        <CardContent>
          <div>
            <TextField
              ...
              helperText={
                hasError
                  ? 'The field is required, and valid value is testuser'
                  : ''
              }
            />
            <TextField
              ...
              helperText={
                hasError
                  ? 'The field is required, and valid value is password'
                  : ''
              }
            />
          </div>
        ...
        <CardActions>
          <LoginButton
            ...
            onClick={() =>
              processLogin(username, password, setLoading, form, sethasError)
            }
            loading={loading}
          >
            Login
